    ...
    <!--begin::Form-->
        <form id="group-form" action="{{ $route }}" method="POST"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <select class="form-control kt-selectpicker"
                                name="expense_category_id" id="expense_category_id" onchange="if (this.value== 2){this.form['other'].style.visibility='visible'}else {this.form['other'].style.visibility='hidden'};">
           ...
           <div class="form-group row"  style="visibility: hidden;">
                    <label  class="col-2 col-form-label">Write Here *</label>
                    <div class="col-10">
                        <textarea type="textbox" name="other" placeholder="  Write here" style="width: 100%"></textarea>
                    </div>
                </div>
