...
class HajjPaymentController extends Controller
{
    private $hajj_type;
    ...
    public function store(Request $request)
    {
        ...
        if ($payment) {
            ...
            return redirect()->route('hajj-payment.index');
        } else {
...
$bs = Bank::all();
        ...
        return view('Admin.hajj-payment.form', compact('hajj_type', 'haji', 'hajj_payment'),['banks'=>$banks,'bs'=>$bs]);
    }
